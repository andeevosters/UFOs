...
// 3. Use the updateFilters() function to do as it says; it will replace your handleClick() function 
...
function updateFilters() {
  ...
  // 2. Attach an event to listen for changes to each filter. modify the event listener from this module 
